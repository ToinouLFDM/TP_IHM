...
public class Date implements Comparable <Date>, Serializable{
	...
	public Date(int parJour,int parMois,int parAn)throws ExceptDate{
		...
		d.set(d.YEAR, parAn);
		d.set(d.MONTH,parMois-1);
		d.set(d.DAY_OF_MONTH, parJour);
		
		chAn=parAn;
		chMois=parMois;
		chJour=parJour;
		chJourNom=(d.get (Calendar.DAY_OF_WEEK)==1)?7:d.get (Calendar.DAY_OF_WEEK)-1;
		jourSemaine = (d.get (Calendar.DAY_OF_WEEK)==1)?7:d.get (Calendar.DAY_OF_WEEK)-1;
